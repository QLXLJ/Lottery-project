...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //彩票项目的基础模块
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function setOpenCode(code) {
	            ...
	            try {
	                for (var _iterator2 = code.value()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	        ...
	        value: function changePlayNav(e) {
	            var self = this;
	            var $cur = (0, _jquery2.default)(e.currentTarget); //发生在某事件上的子元素
	            $cur.addClass('active').siblings().removeClass('active'); //除去除了当前操作类的其他兄弟
	            self.cur_play = $cur.attr('desc').toLocaleLowerCase(); //把大写传换成小写
	            (0, _jquery2.default)('#zx_sm span').html(self.play_list.get(self.cur_play).tip); //信息表述添加
	            (0, _jquery2.default)('.boll-list .btn-boll').removeClass('btn-boll-active'); //清除上一次玩法的类
	        ...
	        value: function getTotal() {
	            var count = 0;
	            (0, _jquery2.default)('.codelist li').each(function (pindex, item) {
	        ...
	        value: function getRandom(num) {
	            var arr = [],
	                index = void 0;
	            var number = Array.from(this.number); //将集合转换成数组
	            while (num--) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //接口文件
